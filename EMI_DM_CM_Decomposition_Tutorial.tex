...
\begin{circuitikz}[american, scale=0.82, transform shape]
  ...
  \draw (0,2) node[ocirc]{}
        ...
        to[L, l=$L$]  (5.0,2)
        -- (8.5,2);
  \fill[black] (6.2,2) circle (2.2pt);               % branch junction for C_1
  \draw[->, thick] (0.25,2.38) -- (1.1,2.38)
        node[midway, above, font=\small]{$i_1$};
  \draw[->, thick] (7.1,2.38) -- (8.1,2.38)
        node[midway, above, font=\small]{$i_1'$};
  ...
  \draw (0,0) node[ocirc]{}
        ...
        to[L, l_=$L$] (5.0,0)
        -- (8.5,0);
  \fill[black] (6.9,0) circle (2.2pt);               % branch junction for C_2
  \draw[->, thick] (0.25,-0.38) -- (1.1,-0.38)
        node[midway, below, font=\small]{$i_2$};
  \draw[->, thick] (7.6,-0.38) -- (8.4,-0.38)
        node[midway, below, font=\small]{$i_2'$};

  %--- Shunt capacitors — shared common ground bus ---
  % C_1 at x = 6.2; its lower lead crosses line 2's wire (no dot = no connection)
  \draw (6.2,2) to[C, l=$C$]  (6.2,-2.1);
  % C_2 at x = 6.9
  \draw (6.9,0) to[C, l_=$C$] (6.9,-2.1);
  % Common ground bus connecting both cap bottoms
  \draw (5.6,-2.1) -- (7.5,-2.1);
  \draw (6.55,-2.1) node[ground]{};
  ...
  \draw[dashed, thin] (Pnd) -- (-1.5,-2.1) node[ground]{};
...
\begin{circuitikz}[american, scale=0.82, transform shape]
  ...
  %--- Shunt capacitors — shared common ground bus ---
  % C_1 at x = 6.0; lower lead crosses lines 2 and 3 (no dot = no connection)
  \draw (6.0,4) to[C, l=$C$]   (6.0,-2.5);
  % C_2 at x = 6.8; lower lead crosses line 3 (no dot = no connection)
  \draw (6.8,2) to[C, l=$C$]   (6.8,-2.5);
  % C_3 at x = 7.6 — asymmetric
